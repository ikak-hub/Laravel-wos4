...
Route::middleware('guest')->group(function () {
    Route::get('/otp', [GoogleController::class, 'showOtpForm'])->name('otp.show');
...
Route::prefix('kantin')->name('kantin.')->group(function () {
    ...
    Route::get('/menu/{idvendor}',   [KantinController::class, 'getMenus'])->name('menu');
    Route::post('/order',            [KantinController::class, 'createOrder'])->name('order');
    Route::get('/check/{idpesanan}', [KantinController::class, 'checkPayment'])->name('check');
    Route::get('/pesanan',           [KantinController::class, 'pesananPage'])->name('pesanan');
});
...
Route::prefix('kantor')->name('kantor.')->group(function () {
    ...
    Route::middleware([CheckVendorSession::class])->group(function () {
        ...
        Route::get('/menu',                  [VendorController::class, 'menuIndex'])->name('menu');
        ...
        Route::get('/scan',                  [VendorController::class, 'scanPage'])->name('scan');
        Route::get('/scan-result/{orderId}', [VendorController::class, 'scanResult'])->name('scan.result');
    });
});
...
// Sistem Antrian (public — tidak butuh auth) 
...
Route::post('/admin/panggil-langsung/{id}',      [AntrianController::class, 'panggilLangsung'])->name('antrian.panggilLangsung');
Route::post('/admin/selesai/{id}',               [AntrianController::class, 'selesai'])->name('antrian.selesai');
